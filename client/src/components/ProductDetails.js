...
const ProductDetails = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="p-5 product-details-page">
        <div className="p-2 row container product-details">
          ...
          <div className="col-md-6 product-details-info text-center">
        ...
        <div className="row container similar-products">
          ...
          <div className="d-flex flex-wrap main">
